...
<form action={{route('barangkeluar.update', $data->id)}} method="POST">
    ...
    @endif
    <input type="text" name="tgl_keluar" class="border rounded p-1 w-full" style="display:none" value={{now()}}>

    <label for="qty_masuk">Kuantitas Masuk</label>
    <input type="text" name="qty_keluar" id="qty_keluar" class="form-control" value="{{$data->qty_keluar}}">
